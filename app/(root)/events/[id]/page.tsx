...
//params are just the words in the url, its a nextJS word, not a variable
export default async function EventDetails({ params: { id }, searchParams}: SearchParamProps){
    const event = await getEventById(id);

    const relatedCategories = await getRelatedEventsByCategory({
        categoryId: event.category._id,
        eventId: event._id,
        page: searchParams.page as string
    })

    const sameOrganizer = await getRelatedEventsByOrganizer({
                ...
                <div className="flex w-full flex-col gap-8 p-5 md:p-10">
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="p-regular-20 flex items-center gap-3">
                            <Image
                             src='/assets/icons/location.svg' alt="Location"
                             width={32} height={32}
                            />
