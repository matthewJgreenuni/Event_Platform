...
export default function EventForm({ userId, type, event, eventId }: EventFormProps){
  ...
  return(
    //the Form and form tag encapsulates everything
    //most of this is from shad
      <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-5 md:flex-row">
              ...
              {/*This ones a pain in the ass, check notes, it uses upload thing*/}
              <FormField
                control={form.control}
                name="imageUrl"
                render={({ field }) => (
            ...
            {/*This has a form field in a form field so its more confusing, but useful to know */}
            <div className="flex flex-col gap-5 md:flex-row">
              <FormField
                control={form.control}
                name="price"
                render={({ field }) => (
                  <FormItem className="w-full">
                    <FormControl>
                      <div className="flex-center h-[54px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2">
                        <Image
                         src="/assets/icons/dollar.svg" alt="Price"
                         width={24} height={24}
                         className="filter--grey"
                        />
                ...
                render={({ field }) => (
                  <FormItem className="w-full">
                    <FormControl>
                      <div className="flex-center h-[54px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2">
                        <Image
                         src="/assets/icons/link.svg" alt="link"
                         width={24} height={24}
                        />
